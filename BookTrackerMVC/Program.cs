...
var connectionString = builder.Configuration.GetConnectionString("BookTrackerMVCContextConnection") ?? throw new InvalidOperationException("Connection string 'BookTrackerMVCContextConnection' not found.");
